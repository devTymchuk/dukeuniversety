 ...
 *
 * <p>
 * All locations generated by the {@link LocationManager} are guaranteed to have
...
public class Location {
	...
	/**
	 * Constant used to specify formatting of a latitude or longitude in the
	 * form "[+-]DDD:MM.MMMMM" where D indicates degrees and M indicates minutes
	 * of arc (1 minute = 1/60th of a degree).
	 */
	public static final int FORMAT_MINUTES = 1;

	/**
	 * Constant used to specify formatting of a latitude or longitude in the
	 * form "DDD:MM:SS.SSSSS" where D indicates degrees, M indicates minutes of
	 * arc, and S indicates seconds of arc (1 minute = 1/60th of a degree, 1
	 ...
	 * LocationFudger. Allows location providers to flag locations as being safe
	 * for use with ACCESS_COARSE_LOCATION permission.
	 *
	 * @hide
	 */
	...
	/**
	 * Bundle key for a version of the location containing no GPS data. Allows
	 * location providers to flag locations as being safe to feed to
	 * LocationFudger.
	 *
	 * @hide
	 */
	 ...
	 *
	 * <p>
	 * By default time, latitude and longitude are 0, and the location has no
	 * bearing, altitude, speed, accuracy or extras.
	 *
	 * @param provider
	 ...
	 *
	 * <p>
	 * Note that the UTC time on a device is not monotonic: it can jump forwards
	 * or backwards unpredictably. So always use
	 * {@link #getElapsedRealtimeNanos} when calculating time deltas.
	 *
	 * <p>
	 * On the other hand, {@link #getTime} is useful for presenting a human
	 * readable time to the user, or for carefully comparing location fixes
	 * across reboot or across devices.
	 *
	 * <p>
	 * All locations generated by the {@link LocationManager} are guaranteed to
	 * have a valid UTC time, however remember that the system time may have
	 ...
	 * {@link android.os.SystemClock#elapsedRealtimeNanos}, to calculate the age
	 * of a fix and to compare Location fixes. This is reliable because elapsed
	 * real-time is guaranteed monotonic for each system boot and continues to
	 * increment even when the system is in deep sleep (unlike {@link #getTime}.
	 *
	 * <p>
	 * All locations generated by the {@link LocationManager} are guaranteed to
	 * have a valid elapsed real-time.
	 *
	 ...
	 *
	 * <p>
	 * Following this call {@link #hasAltitude} will return false, and
	 * {@link #getAltitude} will return 0.0.
	 */
	 ...
	 *
	 * <p>
	 * Following this call {@link #hasSpeed} will return false, and
	 * {@link #getSpeed} will return 0.0.
	 */
	 ...
	 *
	 * <p>
	 * Bearing is the horizontal direction of travel of this device, and is not
	 * related to the device orientation. It is guaranteed to be in the range
	 * (0.0, 360.0] if the device has a bearing.
	 *
	 * <p>
	 ...
	 * <p>
	 * Bearing is the horizontal direction of travel of this device, and is not
	 * related to the device orientation.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * Following this call {@link #hasBearing} will return false, and
	 * {@link #getBearing} will return 0.0.
	 */
	 ...
	 *
	 * <p>
	 * This accuracy estimation is only concerned with horizontal accuracy, and
	 * does not indicate the accuracy of bearing, velocity or altitude if those
	 * are included in this Location.
	 *
	 * <p>
	 * If this location does not have an accuracy, then 0.0 is returned. All
	 * locations generated by the {@link LocationManager} include an accuracy.
	 */
